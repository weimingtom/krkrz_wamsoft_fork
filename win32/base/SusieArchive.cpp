...
public:
	...
	iTJSBinaryStream * CreateStream(tjs_string localname,
...
//---------------------------------------------------------------------------
iTJSBinaryStream * tTVPSusieArchivePlugin::CreateStream(tjs_string localname,
	unsigned long pos, unsigned long size)
{
	...
	try
	{
		...
		TVPWriteBuffer(memstream, memblock, size);
		TVPStreamSetPosition(memstream, 0);
	}
	catch(...)
	{
...
public:
	...
	iTJSBinaryStream * CreateStreamByIndex(tjs_uint idx);
};
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
iTJSBinaryStream * tTVPSusieArchive::CreateStreamByIndex(tjs_uint idx)
{
	tTJSCriticalSectionHolder(Plugin->GetCS());
