...
//---------------------------------------------------------------------------
/*
	this class provides VCL's TStream adapter for iTJSBinaryStream
*/
...
public:
	__fastcall TTVPStreamAdapter(iTJSBinaryStream *ref);
	/*
...
//---------------------------------------------------------------------------
/*
	this class provides iTJSBinaryStream adapter for IStream
*/
class tTVPBinaryStreamAdapter : public iTJSBinaryStream
{
	typedef iTJSBinaryStream inherited;
