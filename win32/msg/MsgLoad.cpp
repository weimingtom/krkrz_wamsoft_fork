...
const int RESOURCE_IDS[NUM_MESSAGE_MAX] = {
	...
	IDS_TVP_ILLEGAL_CHARACTER_CONVERSION_UTF16TO_UTF8,
	IDS_TVP_REQUIRE_LAYER_TREE_OWNER_INTERFACE_INTERFACE,
	IDS_TVP_REQUIRE_SLASH_END_OF_DIRECTORY,
...
void TVPLoadMessage() {
	...
	TVPIllegalCharacterConversionUTF16toUTF8.AssignMessage( RESOURCE_MESSAGE[NUM_TVP_ILLEGAL_CHARACTER_CONVERSION_UTF16TO_UTF8] );
	TVPRequireLayerTreeOwnerInterfaceInterface.AssignMessage( RESOURCE_MESSAGE[NUM_TVP_REQUIRE_LAYER_TREE_OWNER_INTERFACE_INTERFACE] );
	TVPRequireSlashEndOfDirectory.AssignMessage( RESOURCE_MESSAGE[NUM_TVP_REQUIRE_SLASH_END_OF_DIRECTORY] );
