...
process_exp_stub("../visual/WindowImpl.h");
...
open(OKFH, ">$output_krkrz_h") or die;
print OKFH $copyright;
...
process_exp_stub_head("../../tjs2/tjsTypes.h");
process_exp_stub_head("../../tjs2/tjsConfig.h");
process_exp_stub_head("../../tjs2/tjsInterface.h");
process_exp_stub_head("../../tjs2/tjsVariant.h");
process_exp_stub_head("../../tjs2/tjsArray.h");
process_exp_stub_head("../../tjs2/tjsDictionary.h");
process_exp_stub_head("../../tjs2/tjs.h");
process_exp_stub_head("../../utils/ThreadIntf.h");
