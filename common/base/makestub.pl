...
sub make_func_stub
{
	local($rettype, $name, $arg, $type, $prefix, $isconst, $isstatic, $envname,
	...
	$mangled .= "\t".get_ret_type($rettype, $prefix).
		"(STDCALL *  __TVP_Stub_$md5)($type *_this".($arg ne '' ? ', ' : '').normalize_string($arg).")";
	...
	$functype = get_ret_type($rettype, $prefix).
		"(STDCALL * __functype)(".($isconst ? "const ": "").
	...
	if ($envname) {
	print OFH "#else\n";
	print OFH "static void STDCALL TVP_Stub_$md5(){}\n";
	print OFH "#endif // $envname\n";
	}
...
sub list_func_stub
{
	...
	while($content =~ /${prefix}_METHOD_DEF_ENV\(\s*(.*?)\s*,\s*(.*?)\s*,\s*(.*?)\s*,\s*\((.*?)\)\s*\)/sg)
	{
		&make_func_stub($2, $3, $4, $type, $prefix, 0, 0, $1);
	}
	while($content =~ /${prefix}_CONST_METHOD_DEF_ENV\(\s*(.*?)\s*,\s*(.*?)\s*,\s*(.*?)\s*,\s*\((.*?)\)\s*\)/sg)
	{
		&make_func_stub($2, $3, $4, $type, $prefix, 1, 0, $1);
	}
	while($content =~ /${prefix}_STATIC_METHOD_DEF_ENV\(\s*(.*?)\s*,\s*(.*?)\s*,\s*(.*?)\s*,\s*\((.*?)\)\s*\)/sg)
	{
		&make_func_stub($2, $3, $4, $type, $prefix, 0, 1, $1);
	}
	while($content =~ /${prefix}_STATIC_CONST_METHOD_DEF_ENV\(\s*(.*?)\s*,\s*(.*?)\s*,\s*(.*?)\s*,\s*\((.*?)\)\s*\)/sg)
	{
		&make_func_stub($2, $3, $4, $type, $prefix, 1, 1, $1);
	}
}
...
sub make_exp_stub
{
	local($rettype, $name, $arg, $envname, $type, $prefix, $isconst, $str, $mangled, $noreturn, $h, $argnames);
	$rettype = $_[0];
	$name = $_[1];
	$arg = $_[2];
	$envname = $_[4];
...
sub process_exp_stub
{
	...
	while($content =~ /TJS_EXP_FUNC_DEF_ENV\(\s*(.*?)\s*,\s*(.*?)\s*,\s*(.*?)\s*,\s*\((.*?)\)\s*\)/sg)
	{
		&make_exp_stub($2, $3, $4, $5, $1);
	}

	while($content =~ /TJS_EXP_FUNC_DEF\(\s*(.*?)\s*,\s*(.*?)\s*,\s*\((.*?)\)\s*\)/sg)
	{
		&make_exp_stub($1, $2, $3, $4);
	}
...
open(FH, "../../common/tjs2/tjsVariant.h") or die;
$content = <FH>;
...
open(FH, "../../common/tjs2/tjsString.h") or die;
$content = <FH>;
...
open(FH, "../../common/tjs2/tjsVariantString.h") or die;
$content = <FH>;
...
process_exp_stub("../../common/tjs2/tjsTypes.h");

print OFH "#include \"tjsConfig.h\"\n";
process_exp_stub("../../common/tjs2/tjsConfig.h");

print OFH "#include \"tjsVariantString.h\"\n";
process_exp_stub("../../common/tjs2/tjsVariantString.h");

print OFH "#include \"tjsUtils.h\"\n";
process_exp_stub("../../common/tjs2/tjsUtils.h");

print OFH "#include \"tjsString.h\"\n";
process_exp_stub("../../common/tjs2/tjsString.h");

print OFH "#include \"tjsInterface.h\"\n";
process_exp_stub("../../common/tjs2/tjsInterface.h");

print OFH "#include \"tjsErrorDefs.h\"\n";
process_exp_stub("../../common/tjs2/tjsErrorDefs.h");

print OFH "#include \"tjsNative.h\"\n";
process_exp_stub("../../common/tjs2/tjsNative.h");

print OFH "#include \"tjsVariant.h\"\n";
process_exp_stub("../../common/tjs2/tjsVariant.h");

print OFH "#include \"tjsArray.h\"\n";
process_exp_stub("../../common/tjs2/tjsArray.h");

print OFH "#include \"tjsDictionary.h\"\n";
process_exp_stub("../../common/tjs2/tjsDictionary.h");

print OFH "#include \"tjs.h\"\n";
process_exp_stub("../../common/tjs2/tjs.h");

print OFH "#include \"tjsMessage.h\"\n";
process_exp_stub("../../common/tjs2/tjsMessage.h");

print OFH "#include \"tjsGlobalStringMap.h\"\n";
process_exp_stub("../../common/tjs2/tjsGlobalStringMap.h");

print OFH "#include \"tjsObject.h\"\n";
process_exp_stub("../../common/tjs2/tjsObject.h");
