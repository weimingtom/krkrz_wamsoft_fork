...
//---------------------------------------------------------------------------
void tTJSScriptBlock::ExportByteCode( bool outputdebug, iTJSBinaryStream* output ) {
...
//---------------------------------------------------------------------------
void tTJSScriptBlock::Compile( const tjs_char *text, bool isexpression, bool isresultneeded, bool outputdebug, iTJSBinaryStream* output ) {
	if(!text) return;
	if(!text[0]) return;
