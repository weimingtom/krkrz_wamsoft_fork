...
//---------------------------------------------------------------------------
TJS_EXP_FUNC_DEF(void, TJSNativeClassRegisterNCM, (
		tTJSNativeClass *cls,
		const tjs_char *name,
		iTJSDispatch2 *dsp,
		const tjs_char *classname,
		...
		tjs_uint32 flags = 0));
//---------------------------------------------------------------------------
TJS_EXP_FUNC_DEF(void, TJSNativeClassSetClassID, (
		tTJSNativeClass *cls,
		tjs_int32 classid));
...
//---------------------------------------------------------------------------
TJS_EXP_FUNC_DEF(tTJSNativeClassForPlugin *, TJSCreateNativeClassForPlugin,(const ttstr &name, tTJSCreateNativeInstance createinstance));
//---------------------------------------------------------------------------
