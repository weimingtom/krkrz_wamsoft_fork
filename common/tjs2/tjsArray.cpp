...
//---------------------------------------------------------------------------
struct tTJSArraySortCompare_NormalAscending 
{
...
struct tTJSArraySortCompare_NormalDescending
{
	bool operator () (const tTJSVariant &lhs, const tTJSVariant &rhs) const
	{
...
struct tTJSArraySortCompare_NumericAscending
{
	bool operator () (const tTJSVariant &lhs, const tTJSVariant &rhs) const
	{
...
struct tTJSArraySortCompare_NumericDescending
{
	bool operator () (const tTJSVariant &lhs, const tTJSVariant &rhs) const
	{
		if(lhs.Type() == tvtString && rhs.Type() == tvtString)
...
struct tTJSArraySortCompare_StringDescending
{
	bool operator () (const tTJSVariant &lhs, const tTJSVariant &rhs) const
	{
		if(lhs.Type() == tvtString && rhs.Type() == tvtString)
...
struct tTJSArraySortCompare_Functional
{
...
#pragma message("TextEncode;CRLF")
		const static ttstr cr(TJS_W("\r\n"));
#else
#pragma message("TextEncode:LF")
		const static ttstr cr(TJS_W("\n"));
#endif
