...
private:
	...
	void ExportByteCode( bool outputdebug, class iTJSBinaryStream* output );
...
public:
	...
	void Compile( const tjs_char *text, bool isexpression, bool isresultneeded, bool outputdebug, iTJSBinaryStream* output );
