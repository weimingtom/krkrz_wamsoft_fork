...
public:
	...
	virtual void Enqueue( void *data, size_t size, bool last ) {} //< pushされたい場合はこちらを実装
	virtual void Enqueue2( void *data, size_t size, bool last ) {}; //< pullしたい場合はこちらを実装(callback時に呼ばれる)
