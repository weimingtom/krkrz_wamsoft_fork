...
static bool SDLTest_CommonInit(SDLTest_CommonState *state);
static SDLTest_CommonState * SDLTest_CommonCreateState(char **argv, SDL_InitFlags flags);
static void SDLTest_CommonEvent(SDLTest_CommonState *state, SDL_Event *event, int *done);
static void SDLTest_CommonQuit(SDLTest_CommonState *state);
